...
(function ($) {
  $.fn.extend({
    mSwitch: function mSwitch(params) {
      var elements;
  ...
  $.mSwitch.turnOn = function (elem) {
    ...
    if (elem.parent(".m_switch").hasClass("m_switch_color") && elem.next("b.m_switch_b").hasClass("m_switch_checked")) {
  ...
  $.mSwitch.defaults = {
    ...
    onTurnOn: function onTurnOn(elem) {
      return true;
    },
    onTurnOff: function onTurnOff(elem) {
      return true;
    }
  };
})(jQuery);
//# sourceMappingURL=jquery.mswitch.js.map