...
var BBCreditCard = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(BBCreditCard, [{
    key: "getCards",
    value: function () {
      var _getCards = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
              ...
              case 6:
                ...
                return _context.abrupt("return", json.conteiner.telas[0].sessoes[0].celulas.map(function (c) {
                  return c.protocolo.parametros.map(function (p) {
                    ...
                    return _objectSpread(_objectSpread({}, acc), p);
                  }, {});
                }).map(function (c) {
